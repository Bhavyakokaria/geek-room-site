...
export type EventCategory = "hackathon" | "workshop" | "talk" | "other" | "tech-fest";
...
export const eventsData: EventDetails[] = [
  {
    ...
    type: "past",
    category: "tech-fest",
    description: "Geek Veek 2.0 marked an exciting evolution of our flagship tech festival, bringing together over 200 students for a day of hands-on learning and innovation. Building on the success of our inaugural edition, this event expanded to include live coding demonstrations, interactive workshops on AI and web development, and an intense hackathon challenge. The energy was electric as participants collaborated on real-world projects, networked with industry mentors, and showcased their creative solutions to pressing tech problems. From the morning kickoff to the evening awards ceremony, the campus buzzed with the spirit of technological curiosity that defines GeekRoom.",
