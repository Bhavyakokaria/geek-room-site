    ...
    <>
      ...
      <div className="fixed top-4 left-4 z-0 pointer-events-none opacity-30">
        <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M 15 0 L 0 0 L 0 15" stroke="#4F9EFF" strokeWidth="1" fill="none" />
          <path d="M 30 0 L 0 0 L 0 30" stroke="#4F9EFF" strokeWidth="0.5" opacity="0.5" fill="none" />
          <circle cx="5" cy="5" r="2" fill="#4F9EFF" />
        </svg>
      </div>
      ...
      <div className="fixed bottom-4 right-4 z-0 pointer-events-none opacity-30">
        <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M 45 60 L 60 60 L 60 45" stroke="#4F9EFF" strokeWidth="1" fill="none" />
          <path d="M 30 60 L 60 60 L 60 30" stroke="#4F9EFF" strokeWidth="0.5" opacity="0.5" fill="none" />
          <circle cx="55" cy="55" r="2" fill="#4F9EFF" />
        </svg>
      </div>
    </>
  );
